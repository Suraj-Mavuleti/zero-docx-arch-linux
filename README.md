...
This repository contains the highly optimized, native **Arch Linux** build of Zero Docx. It is engineered from the ground up to utilize native Arch Linux windowing and graphics APIs for zero-latency input and maximum performance, aiming to outperform industry standards.
...
```bash
git clone https://github.com/Suraj-Mavuleti/zero-docx-arch-linux.git
cd zero-docx-arch-linux
makepkg -si
```
